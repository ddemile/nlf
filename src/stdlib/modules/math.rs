...
module!("math", {
    fn sqrt(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
    ...
    fn pow(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
    ...
    fn abs(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();
    ...
    fn sign(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();
    ...
    fn sin(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();
    ...
    fn cos(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();
    ...
    fn tan(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();
    ...
    fn round(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();
    ...
    fn floor(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();
    ...
    fn ceil(values: &[ValueHolder], _context: Arc<Mutex<ModuleContext>>) -> RuntimeResult {
        let x = argument!(values, ValueHolder::Number, "x", 0);
        let x: f32 = x.into();

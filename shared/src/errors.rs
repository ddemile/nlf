...
pub trait LanguageErrorKind: Debug + Send + Sync {}
...
pub struct LanguageError {
    pub kind: Box<dyn LanguageErrorKind>,
...
impl LanguageError {
    pub fn from(kind: impl LanguageErrorKind + 'static) -> Self {
        Self {
            kind: Box::new(kind),
    ...
    pub fn with_source(kind: impl LanguageErrorKind + 'static, start: usize, end: usize) -> Self {
        Self {
            kind: Box::new(kind),
...
impl LanguageErrorKind for LexerError {}
